...
class Client extends EventEmitter {
    constructor () {
        ...
        // Query MDNS && Query SSDP
        this.queryMDNS(this.querySSDP.bind(this))
    }
    ...
    queryMDNS (callback) {
        ...
        // Query MDNS
        this._triggerMDNS(callback)
    }

    _triggerMDNS (callback) {
        if (this._mdns) this._mdns.query([{name:'_googlecast._tcp.local', type:'PTR'}], callback)
    }
    ...
    update () {
        ...
        // Trigger again MDNS && SSDP in callback
        this._triggerMDNS(this._triggerSSDP.bind(this))
    }
